...
export class UI {
  ...
  update(s:RoundState,dt:number,ready:boolean,reachLabel:string,locked:boolean){
    ...
    this.reticle.classList.toggle('ready',ready);this.el('reach-label').textContent=reachLabel;this.el('play-help').textContent=locked?'WASD move · Shift sprint · Arrows / mouse look · Space / click grab · C jump':'WASD move · Arrows look · Space grab · C jump · Right-drag mouse look';
