...
export class TouchControls {
  ...
  constructor(readonly controls:Controls){
    ...
    canvas.addEventListener('pointerdown',e=>{
      if(!enabled()||e.pointerType==='mouse'||this.lookId!==null)return;e.preventDefault();this.lookId=e.pointerId;this.lookX=e.clientX;this.lookY=e.clientY;capture(canvas,e.pointerId);
    });
    ...
    const releaseLook=(e:PointerEvent)=>{if(e.pointerId===this.lookId)this.lookId=null;};
